...
//
//  Created by Wendy Faulkner on 2/9/17.
...
class DriverTableViewController: UITableViewController, CLLocationManagerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        // find the idstance between user location and request location
        ...
        let distance = driverCLLocation.distance(from: riderCLLocation) / 1000//original distance in meters -> kilometers
