...
//  Flappy Bird
//
//  Created by Wendy Faulkner on 2/4/17.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func setUpGame() {
        ...
        while  i < 3 {
            ...
            self.addChild(bg)
            i+=1
            bg.zPosition = -2 // make background in the farthest back
        }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        if gameOver == false {
            ...
            bird.physicsBody!.isDynamic = true  // gravity doesn't start till user touches screen
